Vue.mixin({
	data: function() {
		return {
			...
			currentPageIndex: 1,
			currentPageSize: 20,
			pageSizeArr: [10,20,30,50,100,300],
			count: 0,
			globalData: {}
		}
	},
	...
	methods: {  
		initPageSize() {
			...
			var operatorBtnsH = 0;
			if (document.getElementById("operatorBtns")) {
				operatorBtnsH = document.getElementById("operatorBtns").clientHeight;
			}
			...
			this.tableHeight = appH - operatorBtnsH - operatorFormH - operatorContainerH - tablePaginationH - 20;
		},   
		/**
		 * 分页，监听分页的pageSize
		 */
